...
namespace Mvc_CNFApp.Controllers
{
    public class AccountHeadController : AppController
    {
        ...
        public JsonResult ItemNameChanged(string changedText, string changedText2)
        {
            var compid = Convert.ToInt16(System.Web.HttpContext.Current.Session["loggedCompID"].ToString());
            Int64 headtypeid = Convert.ToInt64(changedText2);

            String itemId = "";

            var rt = db.GlAccharmstDbSet.Where(n => n.HEADNM.StartsWith(changedText) && n.HEADTP == headtypeid &&
            ...
            String itemId2 = "";
            string remarks = "";
            var rt2 = db.GlAccharmstDbSet.Where(n => n.HEADNM == changedText && n.HEADTP == headtypeid &&
                                                         n.COMPID == compid).Select(n => new
                                                         {
                                                             Headid = n.HEADCD,
                                                             rmks = n.REMARKS
